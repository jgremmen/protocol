 ...
 */
public final class MessageMatcherParserException extends MessageMatcherException
{
  private final String errorMessage;
  private final String syntaxError;


  public MessageMatcherParserException(@NotNull String errorMessage, @NotNull String syntaxError, Exception cause)
  {
    super(errorMessage + '\n' + syntaxError, cause);
